...
func main() {
	...
	// Initialization
	var configFile, topic = ParseArgs()
...
func ParseArgs() (*string, *string) {
	...
	configFile := flag.String("f", "../librdkafka.config", "Path to Confluent Cloud configuration file")
	topic := flag.String("t", "spam", "Topic name")
	flag.Parse()
	if *configFile == "" || *topic == "" {
		flag.Usage()
